...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    let fechasTorneo = {
        "Fecha 1": ["2025-01-24", "2025-01-28"],
        "Fecha 2": ["2025-01-31", "2025-02-03"],
        "Fecha 3": ["2025-02-07", "2025-02-09"],
        "Fecha 4": ["2025-02-11", "2025-02-14"],
        "Fecha 5": ["2025-02-15", "2025-02-19"],
        "Fecha 6": ["2025-02-21", "2025-02-27"],
        "Fecha 7": ["2025-02-28", "2025-03-04"],
        "Fecha 8": ["2025-03-07", "2025-03-10"],
        "Fecha 9": ["2025-03-14", "2025-03-16"],
        "Fecha 10": ["2025-03-22", "2025-03-26"],
        "Fecha 11": ["2025-03-28", "2025-04-01"],
        "Fecha 12": ["2025-04-04", "2025-04-06"],
        "Fecha 13": ["2025-04-10", "2025-04-13"],
        "Fecha 14": ["2025-04-14", "2025-04-17"],
        "Fecha 15": ["2025-04-19", "2025-04-21"],
        "Fecha 16": ["2025-04-27", "2025-04-29"],
        "Fecha 17": ["2025-05-04", "2025-05-04"],
        "Fecha 18": ["2025-05-11", "2025-05-11"],
        "Fecha 19": ["2025-05-18", "2025-05-18"],
    };
...
async function obtenerDatosLiga(liga) {
    try {
        let response = await fetch("../JSONs/resultadoscol.json");
        ...
        <table class="stats-table">
            ...
            <tbody>
                ${equipos.map(e => {
                    ...
                    } else if (e.posicion >= 3 && e.posicion <= 5) {
                        colorFondo = "background-color: #649cd9;";
                    }
                    return `
                        <tr style="${colorFondo}">
