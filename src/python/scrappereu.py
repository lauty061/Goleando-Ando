...
def obtener_fixture_y_tabla(url_fixture, url_tabla, url_goleadores, nombre_liga):
    ...
    for elemento in soup.find_all(["div"], class_=["topnav-fixture", "grupo-container", "partido"]):
        if "topnav-fixture" in elemento.get("class", []):
            fase_actual = elemento.get_text(strip=True).replace(">", "").replace("<", "")
        elif "grupo-container" in elemento.get("class", []):
            grupo_headline = elemento.find("div", class_="grupo-headline")
            if grupo_headline:
                jornada_actual = grupo_headline.get_text(strip=True)
...
ligas = {
    "Uefa Europa League": {
        "fixture": "https://www.tycsports.com/estadisticas/uefa-europa-league/fixture.html",
        "tabla": "https://www.tycsports.com/estadisticas/uefa-europa-league/tabla-de-posiciones.html",
        "goleadores": "https://www.tycsports.com/estadisticas/uefa-europa-league/tabla-de-goleadores.html"
    },
}
...
ruta_archivo = os.path.join(carpeta_destino, "resultadoseu.json")
